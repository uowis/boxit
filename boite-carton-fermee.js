...
rabatExterieur('rabat_dessus_droit_exterieur', L / 2 + T / 2, H + T * 1.5, false, Math.PI, 937.7, 1183.7, 745.9, 910.4);
rabatExterieur('rabat_dessus_gauche_exterieur', -(L / 2 + T / 2), H + T * 1.5, true, Math.PI, 368.7, 614.7, 745.9, 910.4);
...
cartonMesh.name = 'carton_une_piece_fermee';
cartonMesh.castShadow = true;
cartonMesh.receiveShadow = true;

const box = new THREE.Group();
box.name = 'caisse_6_bouteilles_fermee';
box.add(cartonMesh);
